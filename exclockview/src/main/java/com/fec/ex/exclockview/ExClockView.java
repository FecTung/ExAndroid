package com.fec.ex.exclockview;
 ...
 * 仿小米时钟
 */
public class ExClockView extends View {
    ...
    public ExClockView(Context context) {
        this(context, null);
    }

    public ExClockView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ExClockView, defStyleAttr, 0);
        mBackgroundColor = ta.getColor(R.styleable.ExClockView_backgroundColor, Color.parseColor("#237EAD"));
        setBackgroundColor(mBackgroundColor);
        mLightColor = ta.getColor(R.styleable.ExClockView_lightColor, Color.parseColor("#ffffff"));
        mDarkColor = ta.getColor(R.styleable.ExClockView_darkColor, Color.parseColor("#80ffffff"));
        mTextSize = ta.getDimension(R.styleable.ExClockView_textSize, DensityUtils.sp2px(context, 14));
        ta.recycle();
